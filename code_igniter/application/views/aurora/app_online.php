            <form class="form-horizontal aurora_undergrad_form" id="appform"  method="post" action="/">
                <input type='hidden' name='teaching_certificate_license' value=''>
                <input type='hidden' name='teaching_certificate_license_number' value=''>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="personal">
                            <fieldset class="heading-fieldset" id="personal-fieldset" title="Personal Information">
                                ...
                                <fieldset class="control-group">
                                    ...
                                    <div class="controls">
                                        <p> 
                                            <input class="validate v-require v-phone" type="text" id="home_phone" name="home_phone" value="" title="required"> <span class="phone-desc">###-###-####</span>
                                        </p>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="control-group">
                                    ...
                                    <div class="controls">
                                        <p> 
                                            <input class="v-phone" type="text" id="cell_phone" name="cell_phone" value="" title="required"> <span class="phone-desc">###-###-####</span>
                                        </p>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="control-group">
                                    <label class="control-label" class="blockLabel" for="social_tax_id">Social Security/Taxpayer ID number (Last four digits)</label>
                                    <div class="controls">
                                        <p> 
                                            <input class="v-required" maxlength="4" type="text" id="social_tax_id" name="social_tax_id" value="" title=""> xxxx
                                        </p>
                                    </div>
                                </fieldset>
                                ...
                                <fieldset class="control-group">
                                    ...
                                    <div class="controls">
                                        <p> 
                                            <input class="validate v-required v-usDate datepicker" type="text" id="dob" name="dob" title="required"> mm-dd-yyyy
                                        </p>
                                    </div>
                                </fieldset>
                        ...
                        <div class="tab-pane" id="employer">
                            <fieldset class="heading-fieldset" id="employer-fieldset" title="Employer Information">
                                ...
                                <input type='hidden' name='degree_type' value='AC'>
                        ...
                        <div class="tab-pane" id="education">
                            <fieldset class="heading-fieldset" id="education-fieldset" title="Colleges Previously Attended">
                                ...
                                <fieldset id='vet-control' class="control-group">
                                ...
                                <fieldset id='racial_identity_control' class="control-group" style="display:none">
                                    ...
                                    <div id="racial_identity" class="controls">
                                        <ul class='app-check-list'>
                                            ...
                                            <li><input type="checkbox" name="racial_identity[]" value="HP"> - Native Hawaiian or Other Pacific Islander - A person having origins in any of the original peoples of Hawaii, Guam, Samoa, or Pacific Islands.</li>
                            ...
                            <a data-toggle="tab"><input type="button" class="btn" id="employerBackButton" name="employerBackButton" onclick="toEmployer(1)" value="Back To Application Information"></a>
                            <a data-toggle="tab"><input type="button" class="btn btn-primary" id="religiousButton" name="religiousButton" onclick="toAdditional(1)" value="Continue to Education Information"></a>
                        </div>  <!-- demographic -->
                            ...
                            <fieldset class="heading-fieldset" id="additional-fieldset" title="Educational Information">
                                ...
                                <div id='list_prior_colleges' style='display:none'>
                                    <fieldset class="heading-fieldset" id="additional-fieldset" title="Educational Information">
                                        ...
                                        <p>List chronologically all colleges, universities, and technical schools attended. Be sure to include Aurora University Online if you attended here.</p>
                                    </fieldset>

                                    <div style=''>
                                            <div class="alert alert-info">
                                                <p>Please use this form to find your prior colleges CEEB code</p>
                                                State <select class="" id="ceebState" name="ceebState">
                                                <option value="">Select State</option>
                                                ...
                                                <input id='ceebFinderSubmit' type='button' class="btn" value='Find CEEB code'>
                                            </div>
                                        <div id='ceebResultsDiv' class="span5 well" style='float:right;max-height:725px;width:290px;overflow:auto;display:none'>
                                    ...
                                    <fieldset class="control-group">
                                        <label id="txtPriorCollege1ceeblable" class="control-label" for="txtPriorCollege1">College/University</label>
                                        <div class="controls">
                                            <input class="span3" type="text" id="txtPriorCollege1" name="txtPriorCollege1" value="">
                                        </div>
                                    </fieldset>
                                    <fieldset class="control-group">
                                        <label class="control-label" for="txtPriorCollege1ceeb">School CEEB Code</label>
                                        <div class="controls">
                                            <input class="span2" type="text" id="txtPriorCollege1ceeb" name="txtPriorCollege1ceeb" value="">
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" type="text" id="txtPriorCollege2" name="txtPriorCollege2" value="">
                                        </div>
                                    </fieldset>
                                    <fieldset class="control-group">
                                        <label class="control-label" for="txtPriorCollege2ceeb">School CEEB Code</label>
                                        <div class="controls">
                                            <input class="span2" type="text" id="txtPriorCollege2ceeb" name="txtPriorCollege2ceeb" value="">
                                        </div>
                                    </fieldset>
                                    ...
                                    <fieldset class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" type="text" id="txtPriorCollege3" name="txtPriorCollege3" value="">
                                        </div>
                                    </fieldset>
                                    <fieldset class="control-group">
                                        <label class="control-label" for="txtPriorCollege1ceeb">School CEEB Code</label>
                                        <div class="controls">
                                            <input class="span2" type="text" id="txtPriorCollege3ceeb" name="txtPriorCollege3ceeb" value="">
                                        </div>
                                    </fieldset>                           
                                    ...
                                    <fieldset class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" type="text" id="txtPriorCollege4" name="txtPriorCollege4" value="">
                                        </div>
                                    </fieldset>
                                    <fieldset class="control-group">
                                        <label class="control-label" for="txtPriorCollege1ceeb">School CEEB Code</label>
                                        <div class="controls">
                                            <input class="span2" type="text" id="txtPriorCollege4ceeb" name="txtPriorCollege4ceeb" value="">
                                        </div>
                                    </fieldset>    
                                    ...
                                    <fieldset class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="span3" type="text" id="txtPriorCollege5" name="txtPriorCollege5" value="">
                                        </div>
                                    </fieldset>
                                    <fieldset class="control-group">
                                        <label class="control-label" for="txtPriorCollege1ceeb">School CEEB Code</label>
                                        <div class="controls">
                                            <input class="span2" type="text" id="txtPriorCollege5ceeb" name="txtPriorCollege5ceeb" value="">
                                        </div>
                                    </fieldset>   
                        ...
                        <div class="tab-pane longtext" id="other">
                            <fieldset class="heading-fieldset" id="otherInfo-fieldset" title="Other Information">
                                ...
                                <fieldset class="control-group">
                                    <label class="control-label" class="blockLabel" for="current_employer">Current Employer Name</label>
                                    <div class="controls">
                                        <p> 
                                ...
                                <fieldset class="control-group">
                                    <label class="control-label" class="blockLabel" for="current_employer_city">Current Employer city</label>
                                    <div class="controls">
                                        <p> 
                                ...
                                <fieldset class="control-group">
                                    <label class="control-label" class="blockLabel " for="current_employer_state">State</label>
                                    <div class="controls">
                                        <p>
