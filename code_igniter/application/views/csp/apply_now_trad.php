	...
	<head>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                if ($('#apply_now_program_type').val()=='tr') {
		...
		<div class="row">
			<div class="login" style="margin-left:auto;margin-right:auto;width:400px">
				...
				<table style="margin-left: auto; margin-right: auto;">
					...
					<tr><td>Country</td>
                        <td><select class="span3 txt validate v-required" style="height: 40px;" id="country" name="country">
					...
					<tr>
                        <td>
                            <br><br><input type="submit" class="btn-large btn-primary" value="Ready!" onclick="return validate(this.form);">
                        </td>
                    </tr>
				</table>
                </form>	
