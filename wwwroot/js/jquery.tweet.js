...
(function($) {
  $.fn.tweet = function(o){
    var s = $.extend({
      ...
      fetch: 1,                              // [integer]  how many tweets to fetch via the API (set this higher than 'count' if using the 'filter' option)
    ...
    function extract_template_data(item){
      ...
      o.time = t('<span class="tweet_time"><a href="{tweet_url}" title="view tweet on twitter">{tweet_relative_time}</a></span><br/>', o);
